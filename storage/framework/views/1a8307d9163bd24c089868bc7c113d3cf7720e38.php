...
<?php $__env->startSection('content'); ?>
	...
	<?php if(Session::has('colupdatemsg')): ?>
		<div class="alert alert-success" style="color:green">
			<?php echo e(Session::get('colupdatemsg')); ?>
...
<script type="text/javascript" language="javascript" src="<?php echo e(URL::asset('assets/js/itf_popup.min.js')); ?>"></script>
<script type="text/javascript" language="javascript" src="<?php echo e(URL::asset('assets/js/itf_popup.js')); ?>"></script>

 <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/itf_popup.css')); ?>">
