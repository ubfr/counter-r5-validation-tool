<?php $__env->startSection("content"); ?>
    ...
    <div class="main-content">
    	<?php if(Session::has('logoutMsg')): ?>
    		<div class="alert alert-success">
                <?php echo e(Session::get('logoutMsg')); ?>
			...
			<input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
                <fieldset>
                    ...
                    <div class="form-group">
                        <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" class="form-control input-lg" placeholder="Email Address">
                       <span style="color:#ff0000"> <?php echo e($errors->login->first('email')); ?></span> 
				  </div>
					 
                    <div class="form-group">
                        <input type="password" name="password" id="password" class="form-control input-lg" placeholder="Password">
						<span style="color:#ff0000"><?php echo e($errors->login->first('password')); ?></span> 
                    </div>
    ...
    <span style="color:#ff0000"><?php echo e(Session::get('error')); ?></span>
<?php endif; ?>
                    <hr class="colorgraph">
                    <div class="row">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						...
						<span style="color:#ff0000"><?php echo e($errors->register->first('first_name')); ?></span>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						...
						<span style="color:#ff0000"><?php echo e($errors->register->first('last_name')); ?></span>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<span style="color:#ff0000"><?php echo e($errors->register->first('display_name')); ?></span>
			</div>
			<div class="form-group">
				...
				<span style="color:#ff0000"><?php echo e($errors->register->first('email')); ?></span>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="password" name="password" id="password" class="form-control input-lg" placeholder="Password" tabindex="5">
						<span style="color:#ff0000"><?php echo e($errors->register->first('password')); ?></span>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="password" name="password_confirmation" id="password_confirmation" class="form-control input-lg" placeholder="Confirm Password" tabindex="6">
						<span style="color:#ff0000"><?php echo e($errors->register->first('password_confirmation')); ?></span>
					</div>
				</div>
			</div>
			<div class="row">
